        ...
        private int GetAudioChannelCount(AudioSpeakerMode speakerMode)
        {
            switch (speakerMode)
            {
                ...
                case AudioSpeakerMode.Raw:
                    Debug.LogError("[DemolitionMedia] AudioSpeakerMode.Raw is unsupported");
                    return 0;
                case AudioSpeakerMode.Prologic:
                    Debug.LogError("[DemolitionMedia] AudioSpeakerMode.Prologic is unsupported");
                    return 0;
                default:
                    Debug.LogError("[DemolitionMedia] " + speakerMode.ToString() + " is unsupported");
                    return 0;
            }
        }
        #endregion
